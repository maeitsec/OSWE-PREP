...
- [ ] [Read Web Application Hacker’s handbook, again if you already did](https://www.amazon.com/Web-Application-Hackers-Handbook-E ploiting-ebook/dp/B005LVQA9S)
...
- [ ] [Get familiar with rege ](https://rege 101.com/)
...
### Before registering for the OSWE E am:

####  SS to RCE
- [ ] [AtMail Email Server Appliance 6.4 - [ ] Persistent Cross-Site Scripting](https://www.e ploit-db.com/e ploits/20009)
- [ ] [Chaining  SS, CSRF to achieve RCE](https://rhinosecuritylabs.com/application-security/labkey-server-vulnerabilities-to-rce/)
- [ ] [Code analysis to gaining RCE](https://sarthaksaini.com/2019/awae/ ss-rce.html)
- [ ] [Magento 2.3.1: Unauthenticated Stored  SS to RCE](https://blog.ripstech.com/2019/magento-rce-via- ss/)
- [ ] [Mybb 18.20 From Stored  SS to RCE](https://medium.com/@knownsec404team/the-analysis-of-mybb-18-20-from-stored- ss-to-rce-7234d7cc0e72)

#### Bypassing File Upload Restrictions:

- [ ] [[Paper] File Upload Restrictions Bypass](https://www.e ploit-db.com/docs/english/45074-file-upload-restrictions-bypass.pdf)
- [ ] [Shell the web - [ ] Methods of a Ninja](http://www.securityidiots.com/Web-Pentest/hacking-website-by-shell-uploading.html)
- [ ] [Unrestricted File Upload](https://www.owasp.org/inde .php/Unrestricted_File_Upload)
- [ ] [Atlassian Crowd Pre-auth RCE](https://www.corben.io/atlassian-crowd-rce/)
- [ ] [Popcorn machine from HackTheBo ](https://www.youtube.com/watch?v=NMGsnPSm8iw)
- [ ] [Vault machine from HackTheBo ](https://www.youtube.com/watch?v=LfbwlP ToBc)
...
- [ ] [ATutor 2.2.1 - [ ] Directory Traversal / Remote Code E ecution](https://www.e ploit-db.com/e ploits/39639)
- [ ] [Cubecart Admin Authentication Bypass](https://blog.ripstech.com/2018/cubecart-admin-authentication-bypass/)
- [ ] [Trendmicro smart protection bypass to RCE](https://underdefense.com/n-day-e ploit-development-and-upgrade-to-rce/)
...
- [ ] [From SQLi to SHELL (I and II) - [ ] PentesterLab](https://pentesterlab.com/e ercises/from_sqli_to_shell_II/course)
- [ ] [Pre-Auth Takeover of O ID eShops](https://blog.ripstech.com/2019/o id-esales-shop-software/)
- [ ] [Blind SQL Injection](https://www.acuneti .com/websitesecurity/blind-sql-injection/)
- [ ] [[Paper] PostgreSQL Injection](https://www.infigo.hr/files/INFIGO-TD-2009-04_PostgreSQL_injection_ENG.pdf)
- [ ] [Having Fun With PostgreSQL](http://www.leidecker.info/pgshell/Having_Fun_With_PostgreSQL.t t)
...
- [ ] [E ploiting H2 SQL injection to RCE](https://blog.ripstech.com/2019/dotcms515-sqli-to-rce/)  
...
- [ ] [Remote Code E ecution in math.js](https://capacitorset.github.io/mathjs/)
- [ ] [Arbitrary code e ecution in fast-redact](https://itne t.io/how-i-e ploited-a-remote-code-e ecution-vulnerability-in-fast-redact-9e69fa35572f)
- [ ] [NVIDIA GeForce E perience OS Command Injection - [ ] CVE-2019-5678](https://rhinosecuritylabs.com/application-security/nvidia-rce-cve-2019-5678/)
...
- [ ] [Escape NodeJS Sandbo es](https://blog.netspi.com/escape-nodejs-sandbo es/)
...
- [ ] [Type Juggling, PHP Object Injection, SQLi](https://fo glovesecurity.com/2017/02/07/type-juggling-and-php-object-injection-and-sqli-oh-my/)
- [ ] [Writing E ploits For PHP Type Juggling](http://turbochaos.blogspot.com/2013/08/e ploiting-e otic-bugs-php-type-juggling.html)
...
- [ ] [Detailed E planation of PHP Type Juggling Vulnerabilities](https://www.netsparker.com/blog/web-security/php-type-juggling-vulnerabilities/)
- [ ] [[Video] PHP Type Juggling Vulnerabilities, Netsparker](https://www.youtube.com/watch?v=ASYuK01H3Po)
- [ ] [[Video] Falafel machine from HackTheBo ](https://www.youtube.com/watch?v=CUbWpteTfio)
...
- [ ] [[Paper] Deserialization Vulnerability](https://www.e ploit-db.com/docs/english/44756-deserialization-vulnerability.pdf)
- [ ] [Serialization : A Big Threat](https://klezvirus.github.io/The_Big_Problem_of_Serialisation/)

##### JAVA Deserialization

- [ ] [Understanding & practicing java deserialization e ploits](https://diablohorn.com/2017/09/09/understanding-practicing-java-deserialization-e ploits/)
- [ ] [Understanding JAVA Deserialization](https://nytrosecurity.com/2018/05/30/understanding-java-deserialization/)
- [ ] [E ploiting blind Java deserialization with Burp and Ysoserial](https://www.n00py.io/2017/11/e ploiting-blind-java-deserialization-with-burp-and-ysoserial/)
- [ ] [Details on Oracle Web Logic Desrialization](https://www.thezdi.com/blog/2020/5/8/details-on-the-oracle-weblogic-vulnerability-being-e ploited-in-the-wild)
...
- [ ] [[Video] Matthias Kaiser - [ ] E ploiting Deserialization Vulnerabilities in Java](https://www.youtube.com/watch?v=VviY3O-euVQ)
...
- [ ] [E ploiting Deserialisation in ASP.NET via ViewState](https://soroush.secproject.com/blog/2019/04/e ploiting-deserialisation-in-asp-net-via-viewstate/)
- [ ] [Remote Code E ecution via Insecure Deserialization in Telerik UI](https://labs.bishopfo .com/tech-blog/cve-2019-18935-remote-code-e ecution-in-telerik-ui)
...
- [ ] [[Video] JSON Machine from HackTheBo  - [ ] Ippsec](https://www.youtube.com/watch?v=FPgK_udcBig)  

##### PHP Object Injection/Deserialization

- [ ] [What is PHP Object Injection](https://blog.ripstech.com/2018/php-object-injection/)
- [ ] [phpBB 3.2.3: Phar Deserialization to RCE](https://blog.ripstech.com/2018/phpbb3-phar-deserialization-to-remote-code-e ecution/)
- [ ] [E ploiting PHP Desrialization](https://medium.com/swlh/e ploiting-php-deserialization-56d71f03282a)
...
- [ ] [Attack Surface of PHP Deserialization Vulnerability via Phar](https://medium.com/@knownsec404team/e tend-the-attack-surface-of-php-deserialization-vulnerability-via-phar-d6455c6a1066)
...
- [ ] [[Video] E ploiting PHP7 unserialize (33c3)](https://www.youtube.com/watch?v=_Zj0B4D4TYc)

##### NodeJS Deserialization

- [ ] [E ploiting Node.js deserialization bug for Remote Code E ecution](https://opsec .com/inde .php/2017/02/08/e ploiting-node-js-deserialization-bug-for-remote-code-e ecution/)
- [ ] [The good, the bad and RCE on NodeJS applications](https://www.linkedin.com/pulse/good-bad-rce-remote-code-e ecution-nodejs-ionut-indre/)
- [ ] [Attacking Deserialization in JS](https://www.acuneti .com/blog/web-security-zone/deserialization-vulnerabilities-attacking-deserialization-in-js/)
...
- [ ] [[Video] Celestial machine from HackTheBo  - [ ] Ippsec](https://www.youtube.com/watch?v=aS6z4NgRysU)

####  ML E ternal Entity (  E) Attack

- [ ] [A Deep Dive into   E Injection](https://www.synack.com/blog/a-deep-dive-into-  e-injection/)
- [ ] [From   E to RCE: Pwn2Win CTF 2018 Writeup](https://bookgin.tw/2018/12/04/from-  e-to-rce-pwn2win-ctf-2018-writeup/)
- [ ] [Blind   E to RCE](https://www.ambionics.io/blog/oracle-peoplesoft-  e-to-rce)
- [ ] [Apache Fle  BlazeDS   E Vulnerabilty](https://codewhitesec.blogspot.com/2015/08/cve-2015-3269-apache-fle -blazeds-  e.html)
- [ ] [WebLogic EJBTaglibDescriptor   E](https://medium.com/@knownsec404team/weblogic-ejbtaglibdescriptor-  e-vulnerability-analysis-cve-2019-2888-bd649f5fcfa6)

#### Server Side Template Injection (SSTI)

- [ ] [[Portswigger Research] Server Side Template Injection](https://portswigger.net/research/server-side-template-injection)
- [ ] [[Video] SSTI : RCE For The Modern Web App - [ ] albinowa ](https://www.youtube.com/watch?v=3cT0uE7Y87s)
...
- [ ] [E ploitation of Server Side Template Injection with Craft CMS plugin SEOmatic <=3.1.3](http://ha.cker.info/e ploitation-of-server-side-template-injection-with-craft-cms-plguin-seomatic/)
...
- [ ] [Introduction to Code Review [PentesterLab]](https://pentesterlab.com/e ercises/codereview/course)
...
- [ ] [Shopify Remote Code E ecution - [ ] Hackerone](https://prakhar.prasad.pro/blog/shopify-remote-code-e ecution/)
...
- [ ] [A deep dive into ASP.NET Deserialization](https://medium.com/@swapneildash/deep-dive-into-net-viewstate-deserialization-and-its-e ploitation-54bf5b788817)
- [ ] [Writeups by mr_me](https://srcincite.io/blog/)

#### Youtube Playlist

- [ ] [https://www.youtube.com/watch?v= fbu-pQ1tIc&list=PLwvifWoWyqwqkmJ3ieTG6u USuid95L33](https://www.youtube.com/watch?v= fbu-pQ1tIc&list=PLwvifWoWyqwqkmJ3ieTG6u USuid95L33)  
...
- [ ] [OSWE E am Review 2020 Notes gifts inside - [ ] 21y4d](https://forum.hackthebo .eu/discussion/2646/oswe-e am-review-2020-notes-gifts-inside)
